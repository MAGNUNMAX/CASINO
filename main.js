...
boton.addEventListener('click', () => {
    ...
    let interval = setInterval(() => {
        ...
        if (count < 45) {
           ...
           checkWin(randomNumber1, randomNumber2, lastRandomNumber);
           
        }
    }, 50); // Cambia las imágenes cada 50 milisegundos
});
...
function winnerSound(){
    var audio = new Audio('./asset/sound/coins.wav');
    audio.play();

    var audio = new Audio('./asset/sound/win.wav');
    audio.play();
}